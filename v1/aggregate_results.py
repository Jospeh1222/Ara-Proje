...
#Bir seviye (segment veya sarki) icin tum foldlari birlestir
...
def main():
    ...
    #Tum fold sonuc dosyalarini yukle
    results = []
    missing = []
    ...
    #Erken durdurma ozeti: her fold hangi epoch'ta durdu
    print(f"\n{'=' * 60}")
