#Mel-PNG deneyinin tum fold sonuclarini birlestirir
#Her metrik icin ortalama +- std hesaplar
...
def main():
    ...
    if missing:
        ...
        print(f"Calistir: python train_fold_mel.py {missing[0]}")
        return
    ...
    out = {
        "experiment": "mel_png_custom_cnn",
        "segment_level": seg_summary,
        "song_level":    song_summary,
    }
    out_path = C.RESULTS_DIR / "cnn_mel_summary.json"
