...
SPLITS_DIR = Path("/content/drive/MyDrive/makam_projesi/splits_v3")
FOLDS_FILE = Path("/content/drive/MyDrive/makam_projesi/splits_v3/folds_spec.json")                     # lokal folds
...
FOLDS_SPEC_FILE = Path("/content/folds_spec_3ch_v3.json")
...
DROPOUT      = 0.5   #Sınıflandırıcıdan önce dropout
CONV_DROPOUT = 0.2   #CNN bloklarından sonra dropout
